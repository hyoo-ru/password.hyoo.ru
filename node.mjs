...
;
	($.$hyoo_password) = class $hyoo_password extends ($.$mol_view) {
		Theme(){
		...
		Master(){
			...
			(obj.value) = (next) => ((this.master(next)));
			return obj;
		}
		Master_block(){
			const obj = new this.$.$mol_form_field();
			(obj.name) = () => ((this.$.$mol_locale.text("$hyoo_password_Master_block_name")));
			(obj.Content) = () => ((this.Master()));
			return obj;
		}
		context(next){
			if(next !== undefined) return next;
		...
		Password_block(){
			const obj = new this.$.$mol_form_field();
			(obj.name) = () => ((this.$.$mol_locale.text("$hyoo_password_Password_block_name")));
	...
	($mol_mem(($.$hyoo_password.prototype), "Logo"));
