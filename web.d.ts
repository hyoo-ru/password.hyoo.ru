...
declare namespace $ {
    ...
    function $mol_crypto_sacred_pass(pass: string, salt: Uint8Array<ArrayBuffer>): Promise<$mol_crypto_sacred>;
}
...
declare namespace $ {
	...
	type $mol_form_field__Content_hyoo_password_15 = $mol_type_enforce<
		...
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_paginator__value_hyoo_password_16 = $mol_type_enforce<
	...
	>
	type $mol_password__value_hyoo_password_18 = $mol_type_enforce<
		ReturnType< $hyoo_password['password'] >
		,
		ReturnType< $mol_password['value'] >
	>
	...
	type $mol_form_field__Content_hyoo_password_21 = $mol_type_enforce<
		...
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_hint__dictionary_hyoo_password_22 = $mol_type_enforce<
		({ 
			'no_store': string,
			'offline': string,
			'strong': string,
	...
	>
	type $mol_page__title_hyoo_password_23 = $mol_type_enforce<
		ReturnType< $hyoo_password['title'] >
		,
		ReturnType< $mol_page['title'] >
	>
	type $mol_page__Logo_hyoo_password_24 = $mol_type_enforce<
		ReturnType< $hyoo_password['Logo'] >
		,
		ReturnType< $mol_page['Logo'] >
	>
	type $mol_page__tools_hyoo_password_25 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['tools'] >
	>
	type $mol_page__body_hyoo_password_26 = $mol_type_enforce<
...
declare namespace $.$$ {
    class $hyoo_password extends $.$hyoo_password {
        ...
        context(next?: string): string;
        index(next?: number): number;
        fields(): ($.$mol_form_field | $.$mol_hint)[];
        password(): string;
        context_clear(): void;
        close(): void;
    }
